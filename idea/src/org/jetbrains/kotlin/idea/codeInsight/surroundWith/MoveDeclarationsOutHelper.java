...
public class MoveDeclarationsOutHelper {
    ...
    private static KotlinType getPropertyType(@NotNull KtProperty property) {
        DeclarationDescriptor propertyDescriptor = ResolutionUtils.resolveToDescriptorIfAny(property, BodyResolveMode.PARTIAL);
        assert propertyDescriptor instanceof PropertyDescriptor : "Couldn't resolve property to property descriptor " + property.getText();
        return ((PropertyDescriptor) propertyDescriptor).getType();
    }
